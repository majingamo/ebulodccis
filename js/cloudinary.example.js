...
// SETUP INSTRUCTIONS:
// 1. Copy this file to js/cloudinary.js
// 2. Replace all placeholder values with your actual Cloudinary credentials
// 3. Never commit js/cloudinary.js to version control
// Get these from: https://console.cloudinary.com/settings/api-keys

const cloudinaryConfig = {
  cloudName: 'YOUR_CLOUDINARY_CLOUD_NAME',
  apiKey: 'YOUR_CLOUDINARY_API_KEY',
  uploadPreset: 'YOUR_UPLOAD_PRESET_NAME' // Create this in Cloudinary Dashboard > Settings > Upload
};
